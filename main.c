...
void carol_compose(void)
{
	...
	page_begin(&about, &about_conf);
		div_begin(FLEX_BEGIN_ROW"width: 100vw; height: auto;");
			div_begin("min-width: 55%; height: 100%; overflow-y: scroll; overflow-x: hidden; padding-right: 25px; padding-left: 15px;");
				...
				div_end();
				div_begin("width: 100%;");
					para("I am a computation and physics undergraduate from Brazil.", "text-align: center;");
					...
					para("Carol and this website -- as well as most of my programming projects -- are written with "
						 ...
						 "keybinds.",
					"width: 100%; text-align: justify;");
					para("Furthermore, all the drawings and texts in this website are created by me and are under the "
